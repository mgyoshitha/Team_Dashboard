...
export function EmployeesPage() {
  const { profiles, allocations, loading, } = useAdminData();
  ...
  return (
    <div>
          ...
          <div className="flex gap-3">
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="partially_allocated">Partial</SelectItem>
              </SelectContent>
            </Select>
                    ...
                    <tr key={e.id} className="hover:bg-gray-50/50">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-gray-700">{alloc}%</span>
                        </div>
                      </td>
                      <td className="px-4 py-3">
      ...
      {editEmployee && <EditEmployeeDialog employee={editEmployee} open={!!editEmployee} onOpenChange={(v) => !v && setEditEmployee(null)} />}
      {deleteEmployee && <DeleteEmployeeDialog employee={deleteEmployee} open={!!deleteEmployee} onOpenChange={(v) => !v && setDeleteEmployee(null)} />}
    </div>
  );
}

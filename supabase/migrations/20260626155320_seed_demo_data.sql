...
-- Seed projects
INSERT INTO public.projects (id, project_name, client_name, description, project_manager, status, priority, project_type, start_date, end_date, required_skills) VALUES
  ('b0000000-0000-0000-0000-000000000001', 'CargoSprint', 'Logistics Co', 'Logistics optimization platform with real-time tracking', 'Sarah Mitchell', 'active', 'high', 'project', '2025-01-15', '2025-12-31', ARRAY['React','Python','PostgreSQL']),
  ('b0000000-0000-0000-0000-000000000002', 'RSNA Imaging', 'MedTech Inc', 'Medical imaging viewer with AI-assisted diagnostics', 'Sarah Mitchell', 'active', 'critical', 'project', '2025-03-01', '2026-02-28', ARRAY['TypeScript','React','GraphQL']),
  ('b0000000-0000-0000-0000-000000000003', 'AgileOne Portal', 'AgileOne', 'Enterprise project management portal', 'Sarah Mitchell', 'active', 'medium', 'accelerator', '2025-02-10', '2025-09-30', ARRAY['Node.js','React','AWS']),
  ('b0000000-0000-0000-0000-000000000004', 'Design System Revamp', 'Internal', 'Company-wide design system modernization', 'Sarah Mitchell', 'planning', 'low', 'poc', '2025-07-01', '2025-11-30', ARRAY['Figma','Design Systems'])
ON CONFLICT (id) DO NOTHING;
